...
const apiKey = "INSERT_YOUR_API_KEY";//if you're cloning this repo
    ...
    try {
        ...
        const res2 = await groq.chat.completions.create({
            ...
            messages: [
                { 
                    role: "system", 
                    content: "Act as Hirohiko Araki. Describe the Stand in 3 sentences total. Format: Appearance, Ability, and Stats [Power:A, Speed:B, Range:C, Durability:D, Precision:E, Potential:A]. Ensure you use different letter grades for variety." 
                },
